...
open Clef.Compiler.AbstractIL.Diagnostics
...
type LexFilterImpl (
    ...
    let tryPushCtxt strict ignoreIndent tokenTup (newCtxt: Context) =
        let rec undentationLimit strict stack =
            ...
            // Test here: Tests/Clef.Compiler.ComponentTests/Conformance/LexicalFiltering/Basic/OffsideExceptions.fs, RelaxWhitespace2_AllowedBefore11
            ...
            // Test here: Tests/Clef.Compiler.ComponentTests/Conformance/LexicalFiltering/Basic/OffsideExceptions.fs, RelaxWhitespace2
    ...
    let rec hwTokenFetch useBlockRule =
        ...
        // Test here: Tests/Clef.Compiler.ComponentTests/Conformance/LexicalFiltering/Basic/OffsideExceptions.fs, RelaxWhitespace2_AllowedBefore9
