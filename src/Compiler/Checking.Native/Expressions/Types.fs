...
module FSharp.Native.Compiler.Checking.Native.Expressions.Types
...
let addLiteralBinding (name: string) (ty: NativeType) (nodeId: NodeId option) (litValue: LiteralValue) (env: TypeEnv) : TypeEnv =
    let binding: NR.ResolvedBinding = {
        QualifiedName = name
        Type = ty
