...
let private mkNativeTypeRef (qualifiedName: string) : TypeConRef =
    ...
    { Name = name; Module = path; ParamKinds = []; Layout = TypeLayout.Reference ArenaAffinity.CurrentActor; NTUKind = None; FieldCount = 0; CaseCount = 0; Qualifiers = None; FieldPinAttributes = Map.empty }
