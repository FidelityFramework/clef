module FSharp.Native.Compiler.Service.Tests.EditorTests
...
open FSharp.Native.Compiler.Tokenization
...
#if !NETCOREAPP // TODO: check why this is needed for .NET Core testing of FSharp.Native.Compiler.Service
