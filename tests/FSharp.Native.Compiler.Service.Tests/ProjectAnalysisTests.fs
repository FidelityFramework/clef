module FSharp.Native.Compiler.Service.Tests.ProjectAnalysisTests
...
open FSharp.Native.Compiler.Symbols.FSharpExprPatterns
open TestFramework
...
//-----------------------------------------------------------------------------------------
// see https://github.com/fsharp/FSharp.Native.Compiler.Service/issues/95
...
//-----------------------------------------------------------------------------------------
// see https://github.com/fsharp/FSharp.Native.Compiler.Service/issues/92
...
//-----------------------------------------------------------------------------------------
// Misc - https://github.com/fsharp/FSharp.Native.Compiler.Service/issues/109
...
//-----------------------------------------------------------------------------------------
// Misc - https://github.com/fsharp/FSharp.Native.Compiler.Service/issues/137
...
#if !NETCOREAPP // TODO: check if this can be enabled in .NET Core testing of FSharp.Native.Compiler.Service
...
// .NET Core SKIPPED: need to check if these tests can be enabled for .NET Core testing of FSharp.Native.Compiler.Service"
[<FactForDESKTOP>]
...
[<Fact>]
let ``Test typed AST for struct unions`` () = // See https://github.com/fsharp/FSharp.Native.Compiler.Service/issues/756
    let keepAssemblyContentsChecker = FSharpChecker.Create(keepAssemblyContents=true, useTransparentCompiler=CompilerAssertHelpers.UseTransparentCompiler)
