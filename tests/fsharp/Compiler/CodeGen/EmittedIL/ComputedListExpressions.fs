...
let ListExpressionSteppingTest5 () = 
    [ for x in 1..4 do
        ...
        """,
            (fun verifier -> verifier.VerifyIL [
        """
.class public abstract auto ansi sealed ComputedListExpression05
       extends [runtime]System.Object
{
  .custom instance void [FSharp.Core]Microsoft.FSharp.Core.CompilationMappingAttribute::.ctor(valuetype [FSharp.Core]Microsoft.FSharp.Core.SourceConstructFlags) = ( 01 00 07 00 00 00 00 00 ) 
  .method public static class [FSharp.Core]Microsoft.FSharp.Collections.FSharpList`1<int32> ListExpressionSteppingTest5() cil managed
  {
